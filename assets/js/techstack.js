...
const techStack = [
  ...
  {
    langImage:"assets/images/techstack-page/github.jpeg",
    langName: "GitHub",
    langDesc: "<li>GitHub is a web-based platform that hosts Git repositories, providing developers with tools for version control and collaboration. It combines Git, a powerful version control system, with features that facilitate collaboration and project management</li>"
  },
  {
  ...
  },
  {
    ...
    langName:"MySQL",
    langDesc:"<li>MySQL is an open-source relational database management system that allows for efficient storage, retrieval, and management of data.</li>",
  },
];
